...
##########  Compute the cartesian coordinates of a magnetic field with an arbitrary ##########
#           direction and an arbitrary magnitude, given the spherical coordinates
#           Args:
...
##########  Compute coil currents (in mA) required to generate the desired ##########
#           magnetic field vector. Actuation matrix derived from simulations so far
#           Args:
#           -B_fieldVector: of the B-field, in cartesian coordinates, magnitude in mT
#           -windings: number of windings per coil
#           -resistance: resistance per coil
...
#           Actuation matrix as derived from simulations so far
#           Args:
#           -currVector: currents through the coils 1, 2, 3 (as np.ndarray)
#           -windings: number of windings per coil
#           -resistance: resistance per coil
